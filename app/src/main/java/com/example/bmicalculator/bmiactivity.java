...
public class bmiactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mgphappy=findViewById(R.id.gphappy);
        ...
        if(intbmi<16)
        {
            ...
            mgphappy.setImageResource(R.drawable.sad);
        ...
        else if(intbmi<16.9 && intbmi>16)
        {
            ...
            mgphappy.setImageResource(R.drawable.normal);
        ...
        else if(intbmi<24.9 && intbmi>18.5 )
        {
            ...
            mgphappy.setImageResource(R.drawable.happy);
        }
